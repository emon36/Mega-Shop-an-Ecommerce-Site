...
@section('admin_content')
 ...
 <a href="{{ route('products')}}" class="btn btn-success btn-sm pull-right"> All Product</a>
       ...
       <form method="post" action="{{ route('update.without.image',$product->id) }} " enctype="multipart/form-data">    
        @csrf
...
<br><br>
 ...
 <div class="card pd-20 pd-sm-40">
  ...
  <form method="post" action="{{ route('update.with.image',$product->id) }} " enctype="multipart/form-data">    
        @csrf
