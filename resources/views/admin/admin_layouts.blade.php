...
<html lang="en">
  <head>
    ...
    <title> MegaShop Admin Panel </title>
...
@else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{route('admin.dashboard') }}"> MegaShop </a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('products')}}" class="nav-link">Product list</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('pending.orders') }}" class="nav-link">New Order</a></li>
          ...
          <li class="nav-item"><a href="{{ route('success.payment') }}" class="nav-link">Delivery Success </a></li>
        </ul>
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('todays.order')}}" class="nav-link">Todays Order</a></li>
          <li class="nav-item"><a href="{{route('todays.delivery')}}" class="nav-link">Todays Delivery</a></li>
        </ul>
        <a href="{{route('product.stock')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-gear-outline  tx-24"></i>
