						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li class="hassubs">
										<a href=" {{ url('category/products/'.$cat->id)}}"> {{$cat->category_name }} <i class="fas fa-chevron-right"></i></a>
										<ul>
											@php
											...
											<li class="hassubs">
												...
												<a href="{{ url('subcategory/'.$sub->id)}}">{{ $sub->subcategory_name }}<i class="fas fa-chevron-right"></i></a>
