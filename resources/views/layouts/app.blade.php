...
<meta name="description" content="Mega Shop project">
...
<link rel="stylesheet" type="text/css" href="{{asset('frontend/styles/form-elements.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('frontend/styles/login_style.css')}}">
				...
				<div class="row">
				   ...
				   <a href="" data-toggle="modal" data-target="#exampleModal">My Order Traking</a>                   
							...
							<div class="top_bar_user">
								...
								<ul class="standard_dropdown top_bar_dropdown">
									<li>
								<a href="{{route('home')}}"><div class="user_icon"><img src="{{asset('frontend/images/user.svg')}}" alt=""></div>Profile </a>
								<ul>
	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		<div class="modal-header">
		  <h5 class="modal-title" id="exampleModalLabel">Know your Order Status</h5>
	 ...
	 <form method="post" action="{{ route('order.tracking') }}">
	  ...
	  <div class="modal-body">
	   ...
	   <button class="btn btn-danger ml-3" type="submit">Track Now </button>  
