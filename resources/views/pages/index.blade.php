								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ $row->image_one }}" style="height:120px; width:140px" alt=""></div>
						...
						<div class="owl-carousel owl-theme popular_categories_slider">
							...
							<div class="owl-item">
								<div class="popular_category d-flex flex-column align-items-center justify-content-center">
									...
									<div class="popular_category_text"> {{ $row->subcategory_name }} </div>
								</div>
							</div>
							...
							<div class="row fill_height">
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"> <img src="{{ asset($row->image_one)}}" alt="" style="height: 300px; width:200px;">  </div>
									</div>
								</div>
							</div>
						</div>			
	...
	<div class="modal fade" id="cartmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLavel" aria-hidden="true">
	  ...
	  <div class="col-md-4 col-sm-3">
		...
		<li class="list-group-item">Stock: <span class="badge" style="background: green;color: white;" > Available</span> </li>
		  ...
		  <input type="hidden" name="product_id" id="product_id">
			   ...
			   <div class="form-group">
				  ...
				  <select name="color" class="form-control" id="color" style="width:auto;">
	   ...
	   <div class="form-group">
				  ...
				  <select name="size" class="form-control" id="size" style="width:auto;">
		   ...
		   <input type="number" class="form-control" name="qty" min="1" max="10" value="1" style="width: 50px;"> 
			   </div>   
