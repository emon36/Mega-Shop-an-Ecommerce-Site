...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;"> 
    <div class="contact_form_container">
        <div class="contact_form_title text-center"> Enter your Card Information</div>
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51IBlmuBLSPHrpQhKCHVP610SN5Dq6tuYKmXMNz6QEcal0cLSsX6sWt0taU2OklT4JBUPHGkL6vAlIqO5wQAb3jKv00RHtea151');
