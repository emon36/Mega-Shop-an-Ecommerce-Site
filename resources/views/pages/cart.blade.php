	...
	<div class="cart_section">
		...
		<li class="cart_item clearfix">
			...
			<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
				...
				<div class="cart_item_quantity cart_info_col mt-3">
					<div class="cart_item_title">Quantity</div><br> 

           <form method="post" action=" {{route('update.cart.item')}} ">
           	@csrf
           	<input type="hidden" name="productid" value="{{ $row->rowId }}">
           	<input type="number" name="qty" min="1" max="10" value="{{ $row->qty }}" style="width: 50px;">
           	<button type="submit" class="btn btn-success btn-sm"><i class="fas fa-check-square"></i> </button>
                ...
                <div class="cart_item_total cart_info_col">
					<div class="cart_item_title">Remove Item</div><br>
                 <a href="{{ url('remove/cart/'.$row->rowId ) }}" class="btn btn-sm btn-danger mt-3"> X</a> 
				</div>
